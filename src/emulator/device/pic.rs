...
impl VectorResolver for Pic {
    fn resolve(&self, vector_addr: u16, interrupts: &InterruptController) -> u16 {
        ...
        let recognized = interrupts.active_sources_mask() & self.irq_mask();
    ...
    fn irq_mask(&self) -> u64 {
        (self.ier as u64 & IER_ENABLE_MASK as u64) | !(IER_ENABLE_MASK as u64)
    }
}
