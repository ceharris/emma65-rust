//! Bundled MS BASIC starter-profile template: Microsoft 6502 BASIC's ROM
//! image, its VICE labels file, and a device-layout template (RAM, ROM,
//! console — no VIA/ACIA/PTM, unlike the `default`/TaliForth2 template).
//! Registered as the `"msbasic"` starter-profile template in
//! [`super`](super).
