...
pub use config::{BuildError, Config, CpuVariantSpec, DeviceModule, DeviceModuleError, DeviceRegistry, DeviceSpec, DisplayFrameSlot, DisplayGeometry, DisplayGeometrySlot, ExpandedPathBuf, InstantiationContext, LcdDisplayFrameSlot, LcdDisplayGeometry, LcdDisplayGeometrySlot, LedMatrixFrameSlot, LedMatrixGeometry, LedMatrixGeometrySlot, RamModule, RomModule, TransportSlot, TransportSpec, TransportSpecFormat};
